...
public class ControlPanelStage2 : MonoBehaviour
{
    public AudioSource MusicSound;

    public HelicopterController2 heli;
    public CheckpointControllerStage2 ch2;
    ...
    void FixedUpdate()
    {
        ...
        {
            heli.HelicopterModel.transform.position = ch2.CurrentCheckpoint.transform.position;
        }
