...
public class ControlPanelStage5 : MonoBehaviour
{

    public AudioSource MusicSound;

    public HelicopterController5 heli;
    public CheckpointControllerStage5 ch5;
    ...
    void FixedUpdate()
    {
        ...
        {
            heli.HelicopterModel.transform.position = ch5.CurrentCheckpoint.transform.position;
        }
