...
public class ControlPanelStage3 : MonoBehaviour
{
    public AudioSource MusicSound;

    public HelicopterController3 heli;
    public CheckpointControllerStage3 ch3;
    ...
    void FixedUpdate()
    {
        ...
        {
            heli.HelicopterModel.transform.position = ch3.CurrentCheckpoint.transform.position;
        }
