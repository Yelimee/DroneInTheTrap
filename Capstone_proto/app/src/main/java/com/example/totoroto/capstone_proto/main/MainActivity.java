package com.example.totoroto.capstone_proto.main;
...
import com.example.totoroto.capstone_proto.R;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Thread worker = new Thread() {
            public void run() {
                ...
                try {
                    socket = new Socket("172.20.10.4", 9293);
